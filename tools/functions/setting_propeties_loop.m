dataFolder = datasetFolder + Video_list{vs} + "/";
...
if size(frvids,1) == 0;error("Cannot find video: %s",vidName);end
...
RenderName = sprintf("Results_d%s_sp%i_%ip%if_%sOrder_%sx%i_PixAdj%sUp_alpha%i",...
