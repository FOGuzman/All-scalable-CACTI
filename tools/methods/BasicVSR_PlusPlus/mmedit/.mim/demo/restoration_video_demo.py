...
sys.path.insert(0,'./tools/methods/BasicVSR_PlusPlus/')
...
def parse_args():
    ...
    parser.add_argument('--filename-tmpl',default='f_{:d}_gray.png',help='template of the file names')
    parser.add_argument('--window-size',type=int,default=0,help='window size if sliding-window framework is used')
    parser.add_argument('--max-seq-len',type=int,default=64,help='maximum sequence length if recurrent framework is used')
