...
def main():
    ...
    parser.add_argument('--folder_lq', type=str, default='tools/methods/VRT-main/testsets/in_test',
    ...
    parser.add_argument('--tile', type=int, nargs='+', default=[20,64,64],
                        help='Tile size, [0,0,0] for no tile during testing (testing as a whole)')
    parser.add_argument('--tile_overlap', type=int, nargs='+', default=[2,10,10],
    ...
    save_dir = f'./tools/methods/VRT-main/results/{args.task}'
...
def prepare_model_dataset(args):
    ...
    # download model
    model_path = f'tools/methods/VRT-main/model_zoo/vrt/{args.task}.pth'
    ...
    if os.path.exists(f'{args.folder_lq}'):
        ...
        if 'vimeo' in args.folder_lq.lower():
            ...
            os.makedirs('tools/methods/VRT-main/testsets', exist_ok=True)
