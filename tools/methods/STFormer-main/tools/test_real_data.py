...
def parse_args():
    ...
    parser.add_argument("--work_dir",type=str,default = '../configs/STFormer/stformer_base_real_cr10.py')
    parser.add_argument("--weights",type=str,default = '../checkpoints/stformer_base_real_cr10.pth')
