...
parser.add_argument('--test_dir', type=str, default='./ExtremeCacti_in', help='path to test set')
parser.add_argument('--model_dir', type=str, default='./checkpoint', help='trained or pre-trained model directory')
parser.add_argument('--result', type=str, default='./ExtremeCacti_out', help='results for reconstructed frames')
